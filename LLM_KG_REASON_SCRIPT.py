...
def LLM_Response(news, week_context, general_context):
    try:
        ...
        3. The LAST WEEK CONTEXT NEWS is relevant news titles from the past week. Ensure that this LAST WEEK CONTEXT NEWS is also critically analysed before writing the reasons for the prediction of the stock
        4. The GENERAL CONTEXT is relevant news titles or information in general that is relevant to the provided news. Ensure that this GENERAL CONTEXT NEWS is also critically analysed before writing the reasons for the prediction of the stock
